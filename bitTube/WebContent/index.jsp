...
<head>
	...
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"
	 ...
	 <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/styles.css">
...
<body id="body" style="margin-top: 90px;">
  ...
  <div class="container-fluid">
    <div class="row">
      <nav class="navbar fixed-top">
        ...
        <div class="col-1">
          <img src="${pageContext.request.contextPath}/resource/img/img-logo.jpg" class="logo" alt="" id="logo-bittube">
        </div>
        <div class="col-8">
  ...
  <!-- [END] - Header  -->
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/script.js">
